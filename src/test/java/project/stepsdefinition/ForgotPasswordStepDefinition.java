...
public class ForgotPasswordStepDefinition {
    ...
    public void userInputEmailOnEmailField(String arg0) {
    ...
    public void userSeeErrorMessageOnField(String arg0) {
        
    }

    @Then("User see error message on bottom {string}")
    public void userSeeErrorMessageOnBottom(String arg0) {
